...
class INFAttNet(nn.Module):
    def __init__(self, n_class, deep_supervision=False):
        ...
        self.img_input = Img_Input(img_channels, 64)
        self.img_encoder_1 = Img_Encode_Block(64,128)
        self.img_encoder_2 = Img_Encode_Block(128, 256)
        self.img_encoder_3 = Img_Encode_Block(256, 512)
        self.img_encoder_4 = Img_Encode_Block(512, 1024)
        
        self.inf_input = Inf_Input(inf_channels,64)
        self.inf_encoder_1 = Inf_Encode_Block(64, 128)
        self.inf_encoder_2 = Inf_Encode_Block(128, 256)
        self.inf_encoder_3 = Inf_Encode_Block(256, 512)
        self.inf_encoder_4 = Inf_Encode_Block(512, 1024)
        
        self.inf_encoder_att_1 = Inf_Encode_Att(128)
        self.inf_encoder_att_2 = Inf_Encode_Att(256)
        self.inf_encoder_att_3 = Inf_Encode_Att(512)
        self.inf_encoder_att_4 = Inf_Encode_Att(1024)
        ...
        self.pam_att4 = InfPamAtt(2048,1024)
        self.pam_att3 = InfPamAtt(1024, 512)
        self.pam_att2 = InfPamAtt(512, 256)
        self.pam_att1 = InfPamAtt(256, 128)
        self.pam_att = InfPamAtt(128, 128)
        
        self.cam_att4 = CamAtt(2048)
        self.cam_att3 = CamAtt(1024)
        self.cam_att2 = CamAtt(512)
        self.cam_att1 = CamAtt(256)
        self.cam_att = CamAtt(128)
        
        self.decode_block4 = Decode_Block(2048,1024)
        self.decode_block3 = Decode_Block(1024,512)
        self.decode_block2 = Decode_Block(512, 256)
        self.decode_block1 = Decode_Block(256, 128)
        
        self.resconcate3 = ResConcate(1024,512,512)
        self.resconcate2 = ResConcate(512,256,256)
        self.resconcate1 = ResConcate(256,128,128)
        
        self.seg_output = Seg_Output(128,n_class)

    def forward(self, x):
        img = self.img_input(x)
        img_1 = self.img_encoder_1(img)
        img_2 = self.img_encoder_2(img_1)
        img_3 = self.img_encoder_3(img_2)
        img_4 = self.img_encoder_4(img_3)
        
        inf = self.inf_input(x[:,3:6])
        ...
        inf_4a = self.inf_encoder_4(inf_3a)
        inf_4a = self.inf_encoder_att_4(inf_4a)
        
        seg_4f = torch.cat([img_4, inf_4a], dim=1)
        seg_4f = self.conv(seg_4f)
        seg_4f = self.pam_att4(seg_4f, inf_4a)
        seg_4f = self.cam_att4(seg_4f)
        seg_3f = self.decode_block4(seg_4f)
...
if __name__ == '__main__':
    ...
    model = INFAttNet(2).cuda()
    x = torch.randn((1, 8, 128, 128)).cuda()
    y0 = model(x)
